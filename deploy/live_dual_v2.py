# -*- coding: utf-8 -*-
"""
AI 游戏直播解说系统 V1.2.6 - 双路由防抖客户端
（pHash 去重 + 单局节流 + lite 视觉 + GitHub 图床 + BGM 互锁 + BULLET_CACHE）
...
GAME_NAME          = "王者荣耀"                   # ❹ 今天玩的游戏，每次开播改成实际游戏名
PERSONA            = "娱乐大叔"                   # ❺ 人设：娱乐大叔/软萌甜妹/霸气御姐/佛系技术
...
async def main():
    ...
    print(f"🎙️ AI 解说启动 - 人设：{PERSONA} - 游戏：{GAME_NAME}")
    while True:
        try:
